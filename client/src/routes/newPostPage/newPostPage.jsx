...
function NewPostPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/" + res.data.id), 2000); // Redirect after success
    } catch (err) {
  ...
  return (
    <div className="newPostPage">
      <div className="formContainer">
        <h1>Add New Post</h1>
        {success && (
          <div className="successMessage">Post added successfully!</div>
        )}{" "}
        {/* Success Message */}
        <div className="wrapper">
          <form onSubmit={handleSubmit}>
            ...
            <div className="item">
              ...
              <input id="income" name="income" type="text" required />
            </div>
            <div className="item">
